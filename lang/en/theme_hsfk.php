...
<img class=img-polaroid src="hsfk/pix/screenshot.jpg" />
<h3>Theme Credits</h3>
<p>
<h3>Moodle hsfk theme</h3>
<p>
...
$string['info1title'] = 'Info Links Title (1)';
$string['info1title_default'] = 'Info';
$string['info1title_desc'] = 'Title of the first Links category';
$string['info1links'] = 'Info Links (1)';
$string['info1links_default'] = 'Moodle community|https://moodle.org
Moodle free support|https://moodle.org/support
Moodle development|https://moodle.org/development
Moodle Docs|http://docs.moodle.org|Moodle Docs
Moodle.com|http://moodle.com/';
$string['info1links_desc'] = 'You can configure custom Info Links here to be shown by themes. Each line consists of some menu text, a link URL (optional), a tooltip title (optional) and a language code or comma-separated list of codes (optional, for displaying the line to users of the specified language only), separated by pipe characters.For example:
<pre>
...
$string['info2title'] = 'Info Links Title (2)';
$string['info2title_default'] = 'Legal';
$string['info2title_desc'] = 'Title of the second Links category';
$string['info2links'] = 'Legal Links';
$string['info2links_default'] = 'Terms of Use|/termsofuse
Privacy Policy|/privacy';
$string['info2links_desc'] = 'You can configure custom Info Links here to be shown by themes. Each line consists of some menu text, a link URL (optional), a tooltip title (optional) and a language code or comma-separated list of codes (optional, for displaying the line to users of the specified language only), separated by pipe characters.For example:
<pre>
...
$string['slidecaption'] = 'Caption';
$string['slidecaptiondefault'] = 'Caption of the Slider - {$a->slideno}';
...
$string['main_feature_1_body_default'] = 'on arms control, disarmament, non-proliferation';
$string['main_feature_2_title'] = 'Feature 2 Title';
$string['main_feature_2_title_default'] = '160 Videos';
$string['main_feature_2_body'] = 'Feature 2 Body';
$string['main_feature_2_body_default'] = 'lectures, videos, animations';
$string['main_feature_3_title'] = 'Feature 3 Title';
$string['main_feature_3_title_default'] = '27 Experts';
$string['main_feature_3_body'] = 'Feature 3 Body';
$string['main_feature_3_body_default'] = 'from European think tanks and the EU';
$string['main_feature_4_title'] = 'Feature 4 Title';
$string['main_feature_4_title_default'] = '2 Certificates';
$string['main_feature_4_body'] = 'Feature 4 Body';
$string['main_feature_4_body_default'] = 'pass exams and prove your knowledge';
