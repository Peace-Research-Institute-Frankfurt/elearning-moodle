...
class theme_hsfk_core_course_renderer extends core_course_renderer
{
  ...
  public function frontpage_available_courses()
  {
    ...
    foreach ($course_ids as $course_id) {
      ...
      $content_url_prefix = isset($custom_fields["content_url_prefix"]) && $custom_fields["content_url_prefix"] != "" ? $custom_fields["content_url_prefix"] : "https://nonproliferation-elearning.eu/learningunits/";
      ...
      $courses[] = array(
        ...
        "link" => $content_url_prefix . $course->shortname
      );
    }
    $context = array(
      "courses" => $courses
